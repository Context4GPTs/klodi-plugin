//! `klodi-ironclaw-setup-status` — daemon CLI surface for `klodi_setup_status`.
...
#[derive(Parser, Debug)]
#[command(
    name = "klodi-ironclaw-setup-status",
    about = "Report klodi setup phase + missing files for the IronClaw daemon.",
