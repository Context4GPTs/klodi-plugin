...
|---|---|---|---|
| [[0019-wake-inject-failure-disposition]] | Wake-inject failure disposition by class — timeout swallowed-and-ACKed; deterministic nonzero is a loud correlated alarm, never NAK/redeliver/dead-letter | wake, error-handling, observability, alarm, consumer, ack, adapters, parity, hermes, nats | 2026-06-29 |
